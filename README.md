...
1. Download `Interactive_Sales_Performance_Dashboard.xlsx`.
2. Open it in Microsoft Excel (desktop version recommended, since slicers and Treemap charts work best there).
3. Go to the **Dashboard** sheet and click the slicers to explore the data.
